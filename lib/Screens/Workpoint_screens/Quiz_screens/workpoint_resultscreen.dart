...
import '../../VizScreens/vizlevelscreens/Questions.dart';
import '../../VizScreens/vizlevelscreens/level2/Level2_screen.dart';
import '../level2/level2_screen.dart';

class workpoint_ResultScreen extends StatelessWidget {
  final int score;
  final List<int?> selectedAnswers;
  final List<Question> questions;

  workpoint_ResultScreen({
    required this.score,
                      ...
                      children: [
                        ...
                        Center(
                          child: ElevatedButton(
                            onPressed: () {
                              Get.to( workpoint_LevelTwoScreen(onLevelComplete: () {  },));
                            },
