...
class InternshipFormPage1 extends StatefulWidget {
  const InternshipFormPage1({Key? key}) : super(key: key);

  @override
  State<InternshipFormPage1> createState() => _InternshipFormPage1State();
}

class _InternshipFormPage1State extends State<InternshipFormPage1> {
                  ...
                  TextSpan(
                    children: [
                      ...
                      WidgetSpan(
                        ...
                        child: Icon(Icons.person, color: Colors.deepPurple, size: 20.sp),
                      ),
                    ],
                  ),
                ),
